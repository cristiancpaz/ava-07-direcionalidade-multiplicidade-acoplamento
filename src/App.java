...
//System.out.println(Niobe.toString());//apelido
...
//System.out.println(Mjolnir.toString());//apelido


//System.out.println(Neo.getFirstName()+"testesssss");
...
//System.out.println(Trinity.getFirstName()+"teste");
...
System.out.println(Morpheus.isPlugged()+"testtttttttttttt"); // Morpheus não está.
...
//System.out.println(Neo.isPlugged()+"testtttppp"); // Neo não está na Matrix
System.out.println(matrix.has(Neo)    == false); // Nem a Matrix tem Neo
//System.out.println(matrix.has(Neo)+"ssssss"); // Nem a Matrix tem Neo


System.out.println(Neo.getFirstName() == null); // Temporário até ele voltar
System.out.println(Neo.getFirstName()+"rrrr"); // Temporário até ele voltar
...
System.out.println(Nebuchadnezzar.crewCount()+"testeee");
System.out.println(Nebuchadnezzar.getCaptain().equals(Trinity) == true);
System.out.println(Nebuchadnezzar.getCaptain());// consertar trinity esta retornando null
...
System.out.println(Morpheus.isCaptainOf(Nebuchadnezzar)+"ttttttttttttt");
System.out.println(Nebuchadnezzar.getCaptain()  +"ttttttttttttt");//resultado trinity erro
...
//System.out.println(Logos.getCaptain().getAlias()+"ttttttttttt");
...
System.out.println(Nebuchadnezzar.crewCount() == 5);
System.out.println(Logos.crewCount()          == 3);
System.out.println(Logos.crewCount()+"contagem 3 *****");
...
System.out.println(Logos.crewCount()+" -3**********");//ta adiconando 1 a mais

System.out.println(Mouse.isCrewMemberOf(Nebuchadnezzar) == true);
System.out.println(Mouse.isCrewMemberOf(Logos)          == false);//false

System.out.println(Nebuchadnezzar.crewCount() == 5);
System.out.println(Logos.crewCount()          == 3);//corrigir
...
System.out.println(Mouse.isCrewMemberOf(Logos)+"qqqqqqq");
System.out.println(Mouse.isCrewMemberOf(Nebuchadnezzar) == false);
System.out.println(Mouse.isCrewMemberOf(Logos)          == false);

System.out.println(Logos.crewCount() +" cont");
...
System.out.println(Nebuchadnezzar.crewCount() == 5);
System.out.println(Nebuchadnezzar.crewCount()+"*********");
System.out.println(Logos         .crewCount() == 3);
System.out.println(Logos         .crewCount() +"3");
...
//System.out.println(Morpheus.isPlugged()+"wwwww");
